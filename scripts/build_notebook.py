...
notebook = {
  "cells": [
    ...
    },
    {
      ...
      "outputs": [],
      "source": [
        "# Visualization 2: Best Performing Modules Bar Chart\n",
        "plt.figure(figsize=(12, 6))\n",
        "ax = sns.barplot(\n",
        "    data=module_words,\n",
        "    x='avg_words',\n",
...
with open('notebooks/course_analysis.ipynb', 'w', encoding='utf-8') as f:
  json.dump(notebook, f, indent=2, ensure_ascii=False)

print("Successfully generated notebooks/course_analysis.ipynb")
